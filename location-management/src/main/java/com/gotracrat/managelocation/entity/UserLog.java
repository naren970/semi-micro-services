...
public class UserLog implements Serializable {
    ...
    public boolean isCanNotInsert() {
		return canNotInsert;
	}

	public void setCanNotInsert(boolean canInsert) {
		this.canNotInsert = canInsert;
	}
	...
	public UserLog(String userName, Integer companyID, String userAction, String actionComment, Date logDate) {
		super();
		this.userName = userName;
		this.companyID = companyID;
		this.userAction = userAction;
